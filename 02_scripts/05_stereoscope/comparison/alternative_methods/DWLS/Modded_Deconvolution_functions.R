...
buildSignatureMatrixUsingSeurat2<-function(scdata,id,path,diff.cutoff=0.5,pval.cutoff=0.01){
...
buildSignatureMatrixMAST2<-function(scdata,id,path,diff.cutoff=0.5,pval.cutoff=0.01){
  #compute differentially expressed genes for each cell type
  DEAnalysisMAST(scdata,id,path)
