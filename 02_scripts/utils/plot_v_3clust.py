...
stlnmfV = np.array(pd.read_csv("DEEPNMF_x0_0_clean3.csv", sep=",", header=None))
stlnmfV /= sum(stlnmfV)
...
stereoV /= sum(stereoV)
realV = np.array(pd.read_csv("./00_synthetic/00_PDAC_A/00_No_X_Noise/03_clust/02_v/v/v0_0.csv", sep=" ", header=None))
