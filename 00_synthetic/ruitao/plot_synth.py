...
im_ct1st = ax9.pcolormesh(stereo_ct1, cmap=custom_cmap)
im_ct2st = ax10.pcolormesh(stereo_ct2, cmap=custom_cmap)
im_ct3st = ax11.pcolormesh(stereo_ct3, cmap=custom_cmap)
im_ct4st = ax12.pcolormesh(stereo_ct4, cmap=custom_cmap)
...
im_ct1sp = ax17.pcolormesh(spot_ct1, cmap=custom_cmap)
im_ct2sp = ax18.pcolormesh(spot_ct2, cmap=custom_cmap)
im_ct3sp = ax19.pcolormesh(spot_ct3, cmap=custom_cmap)
im_ct4sp = ax20.pcolormesh(spot_ct4, cmap=custom_cmap)
